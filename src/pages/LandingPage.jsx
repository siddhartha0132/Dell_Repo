...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-[#000000] border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-12">
          ...
          <div className="hidden md:flex items-center gap-1">
            {[
              ...
              { label: 'Transparency', href: '#solution' },
              { label: 'Screens', href: '#screens' },
            ].map(item => (
              <a
                key={item.label}
                href={item.href}
                className="px-3 py-1.5 text-[13px] text-white/60 hover:text-white font-medium rounded-md hover:bg-white/5 transition-all duration-150"
              >
                {item.label}
              </a>
            ))}
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:flex items-center gap-1.5 text-[12px] text-white/50 hover:text-white/80 transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 bg-dell-blue hover:bg-blue-600 text-white px-4 py-1.5 rounded-md text-[13px] font-semibold transition-all duration-150 active:scale-95"
            >
              Launch App
